...
from game_lists_site.models import (Developer, Game, GameDeveloper, GameGenre,
                                    GameTag, Genre, Tag)
from game_lists_site.utils.utils import get_game
...
def game(game_id, game_name):
    ...
    return render_template('game.html', game=game, developers=developers, genres=genres, tags=tags, short_description=short_description)
